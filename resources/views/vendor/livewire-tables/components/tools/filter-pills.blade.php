...
@if ($theme === 'tailwind')
    <div 
        class="bg-white p-3 inline-block w-auto rounded mb-2 shadow shadow-md 
        {{ !($component->filtersAreEnabled() && $component->filterPillsAreEnabled() && $component->hasAppliedFiltersWithValues()) ? 'hidden' : '' }}">
        @if ($component->filtersAreEnabled() && $component->filterPillsAreEnabled() && $component->hasAppliedFiltersWithValues())
            <div class="mb-0 px-4 md:p-0">
